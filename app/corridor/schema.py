...
FIELDS: Dict[str, str] = {
    ...
    "customer.country_risk": "call_for_action | increased_monitoring | eu_high_risk | null (nationality or residence, worst)",
    ...
    "beneficiary.country_risk": "call_for_action | increased_monitoring | eu_high_risk | null",
    "beneficiary.missing_fields": "list",
    "beneficiary.screening.match": "bool|null: beneficiary name/ID screened against the same lists",
    "beneficiary.screening.match_count": "int",
    "beneficiary.screening.best_confidence": "high | medium | low | null",
    "beneficiary.screening.best_dob_agreement": "exact | year | mismatch | unknown | null",
    "beneficiary.screening.best_match_type": "name | alias | identifier | null",
    "beneficiary.screening.best_source": "list source of the best match",
